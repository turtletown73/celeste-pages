...
var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 37552128;
...
var ASM_CONSTS = {
 ...
 1388370: () => Module["SDL3"].audioContext.sampleRate,
 1388421: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 1393975: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 1394034: ($0, $1, $2, $3, $4, $5, $6) => {
  const device = $0;
  const w = $1;
  const h = $2;
   ...
   var makePointerEventCStruct = function(event) {
    ...
    if (event.pointerType == "pen") {
     ...
     if (ptr != 0) {
      ...
      GROWABLE_HEAP_F32()[idx++ >>> 0] = event.clientX - rect.left;
      GROWABLE_HEAP_F32()[idx++ >>> 0] = event.clientY - rect.top;
 ...
 1405229: () => window.innerWidth,
 1405259: () => window.innerHeight,
 1405290: $0 => {
 ...
 1406446: ($0, $1) => {
  ...
  Module["OutputWebAudio_resumeAudio"] = function() {
   if (Module.context && Module.mInputRegistered) {
    ...
    window.removeEventListener("click", Module.OutputWebAudio_resumeAudio, false);
    window.removeEventListener("touchend", Module.OutputWebAudio_resumeAudio, false);
    Module.mInputRegistered = false;
   }
  };
 },
 ...
 1407423: () => {
  window.addEventListener("touchend", Module["OutputWebAudio_resumeAudio"], false);
  window.addEventListener("click", Module["OutputWebAudio_resumeAudio"], false);
 ...
 1409252: ($0, $1) => {
  ...
  Module["OutputAudioWorklet_resumeAudio"] = function() {
   if (Module.mContext && Module.mInputRegistered) {
    ...
    window.removeEventListener("click", Module.OutputAudioWorklet_resumeAudio, false);
    window.removeEventListener("touchend", Module.OutputAudioWorklet_resumeAudio, false);
    Module.mInputRegistered = false;
 ...
 1414863: () => {
  window.addEventListener("touchend", Module["OutputAudioWorklet_resumeAudio"], false);
  window.addEventListener("click", Module["OutputAudioWorklet_resumeAudio"], false);
  Module.mInputRegistered = true;
 },
 1415068: () => {
...
DOTNET.setup({
 ...
 gitHash: "c8acea22626efab11c13778c028975acdc34678f"
});
